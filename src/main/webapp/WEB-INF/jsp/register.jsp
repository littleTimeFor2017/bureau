...
<link href="/bureau/css/font-awesome.css" rel="stylesheet"><!-- Font-awesome-CSS -->
<link href="/bureau/css/style.css" rel='stylesheet' type='text/css'/><!-- style.css -->
...
<body>
	...
	<div class="main-agile">
		...
		<div class="circle-w3layouts"></div>
			<h2>Login</h2>
			<form action="/bureau/user/register" method="post">
