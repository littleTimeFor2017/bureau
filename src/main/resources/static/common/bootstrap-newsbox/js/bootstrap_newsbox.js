...
(function ($, w, d, undefined) {
    ...
    var NewsBox = {
        ...
        onPrev: function() {
            ...
            var html = '<' + self.newsTagName + ' style="display:block;" class="' + self.newsClassName + '">' + $(self.$elem).find(self.newsTagName).last().html() + '</' + self.newsTagName + '>';
        ...
        onNext: function() {
            ...
            var html = '<' + self.newsTagName + ' style="display:block;" class=' + self.newsClassName + '>' + $(self.$elem).find(self.newsTagName).first().html() + '</' + self.newsTagName + '>';
