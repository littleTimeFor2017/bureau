...
<div class="modal-body">
    <form id="lug_sel-search-form" class="form-inline well well-sm well-cln sel_frm" action="" method="POST">
        <input type="text" id="lname" class="form-control ipt-mgn" name="upost.full_name" value="" placeholder="输入岗位名称">
...
<script type="text/javascript">
    ...
    function loadSelUsers(cp){
        ...
        var sel_url = path + "/upost/searchPostByTree.action?oper=multiple&r="+Math.random();
