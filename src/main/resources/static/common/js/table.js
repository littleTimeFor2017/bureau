...
;(function ($) { 
    $.extend({
        XCLTableListDf:function(options){
    ...
    var funs={
        Defaults:{
            tableClass:".tabDf",//table的class
            trHoverColor:"#EEE",//行滑过时的颜色
            trClickColor:"",//单击行后的颜色
            trNoHoverClass:".noHover",//无需设置颜色的行class
            trEvenColor:"#FFF",//偶数行的颜色0开始
            trOddColor:"#F7F7F7",//奇数行的颜色
            checkAllClass:".checkAllDf",//全选按钮class
            checkItemClass:".checkItemDf",//选择框的class
